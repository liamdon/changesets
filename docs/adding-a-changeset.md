...
1. Run the command line script `npx changeset`, `yarn changeset`, or `pnpm changeset`.
...
1. Run the command line script `npx changeset`, or `yarn changeset`, or `pnpm changeset`.
